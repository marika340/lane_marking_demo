...
sys.path.append(f'/home/{uname}/catkin_ws/src/lane_marking_demo/dvs_learning/seg2cmd/models')
from model import *
from ViTsubmodules import *
sys.path.append(f'/home/{uname}/catkin_ws/src/lane_marking_demo/dvs_learning/seg2cmd/utils')
...
if __name__ == '__main__':
    ...
    from train import TRAINER, argparsing
    ...
    args.return_sequence = False  # force single-step inference
    ...
    if not learner.combine_checkpoints:
        ...
        for checkpoint_path in checkpoint_paths:
            ...
            if not (args.model_type == 'OrigUNet' and args.velpred == 0) and not (isinstance(args.model_type, list) and args.model_type[0] == 'OrigUNet' and args.velpred == 0):
                ...
                from eval_plot_and_cmds import eval_masks_and_cmds  # if saved separately

                eval_masks_and_cmds(learner, checkpoint_path, dataSetstoTest=dataSetstoTest)
