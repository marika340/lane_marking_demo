        ...
        for ep in range(self.epochs):
            ...
            for event_batch, mask_batch in self.train_data:
                ...
                if self.model_type == "SimpleCNN":
                    ...
                    loss = F.mse_loss(pred, mask_batch)
...
def argparsing(filename=None):
    ...
    if filename is not None:
        ...
        default_config_files = [f'/home/{uname}/catkin_ws/src/lane_marking_demo/dvs_learning/event2seg/training/configs/train_config_event2seg.txt']
