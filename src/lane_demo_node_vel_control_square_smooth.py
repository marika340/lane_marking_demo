...
class LaneDemoNode(object):
    def __init__(self):
        rospy.init_node("lane_demo_node_vel_control_square_smooth", anonymous=False)
        ...
        np.save("/home/marikan/catkin_ws/src/lane_marking_demo/worlds/track_square_smooth.npy", self.waypoints)
